...
void write_results_to_csv(const char *matrix_name, int num_rows, int num_cols, int nz,
                          ...
                          double time_parallel_simd, double time_parallel_hll, double time_parallel_hll_simd, double speedup_parallel,
                          double speedup_simd, double speedup_hll, double speedup_hll_simd, double efficiency_parallel,
                          double efficiency_simd, double efficiency_hll, double efficiency_hll_simd, double flops_serial, double avg_flops_hll_serial,
                          double flops_parallel, double flops_parallel_simd, double flops_parallel_hll, double flops_parallel_hll_simd, const char *output_file);
